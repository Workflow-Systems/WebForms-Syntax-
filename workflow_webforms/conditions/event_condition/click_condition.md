...
Если тэг `<Object>` отсутствует, то событие срабатывает для всех объектов формы за исключением тех, что указаны в тэге [`<ExceptObjects>`](click_condition.md#except_objects).
...
<table data-header-hidden><thead><tr><th align="center"></th><th width="502.3333333333333"></th></tr></thead><tbody><tr><td align="center">Type</td><td><p>Тип нажатой кнопки.</p><p></p><p>Обязательный атрибут. Ожидается название одного из <a href="click_condition.md#mouse_button_types">типов кнопок мышки</a>.</p></td></tr></tbody></table>
