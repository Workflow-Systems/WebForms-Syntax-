---
description: Тип целого числа (32 бита).
---
...
## Шаблон IntegerDataType <a href="#template_integer_data_type" id="template_integer_data_type"></a>

```xml
<DataType Type="IntegerDataType" Format="" MinValue="" MaxValue="" Precision="" AllowNull="" />
```

### Атрибуты для форматированного вывода значения <a href="#format_attributes" id="format_attributes"></a>

<table data-header-hidden><thead><tr><th width="203.44352355433313" align="center"></th><th width="473.3333333333333"></th></tr></thead><tbody><tr><td align="center">Format</td><td><p>Форматная строка вывода целого числа.</p><p></p><p>Необязательный атрибут.</p></td></tr></tbody></table>
