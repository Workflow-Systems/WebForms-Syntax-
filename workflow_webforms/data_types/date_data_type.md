...
## Шаблон DateDataType <a href="#template_date_data_type" id="template_date_data_type"></a>

```xml
<DataType Type="DateDataType" Format="" ParseFormat="" />
```
...
Аналогично [поддерживаемым константам](date_data_type.md#format_constants) атрибута `Format`.
